...
var view = "manage_student_classes";

// this solves the problem to allow us to have null in a major_id field when we submit
...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        ...
        return res.view(view, {error: { message: "There was an error getting the student classes"}});
    });
  ...
  update: function (req, res) {
    ...
    let student_classId = req.body.student_class_id;
    ...
    client.put(endpoint + "/" + student_classId, args, function (data, response) {
